    ...
    <section id="bo_v_info">
        ...
        <div class="profile_info">
        	...
        	<div class="profile_info_ct">
        		...
        		<strong class="if_date"><span class="sound_only">작성일</span><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo date("y-m-d H:i", strtotime($view['wr_datetime'])) ?></strong> <?php if($is_admin) {?>
			<a onclick="window.open('http://hostingis.com/newcom/sms.php?hp=<?php echo $wr_8?>', '_blank', 'location=yes,height=350,width=350,scrollbars=yes,status=yes');"  class="col4">문자</a>
			<?php } ?>
    		</div>
    	</div>
