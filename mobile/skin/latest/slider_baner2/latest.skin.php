...
<div class="main_slider_baner" id="stap_slider">
 ...
 <!-- Swiper -->
  ...
  <!-- Initialize Swiper -->
  <script>
    var swiper = new Swiper('#stap_slider .swiper-container', {
      pagination: {
        el: '#stap_slider .swiper-pagination',
        dynamicBullets: true,
      	},
		navigation: {
        nextEl: '#stap_slider .swiper-button-next',
        prevEl: '#stap_slider .swiper-button-prev',
      	},
		loop : true,
		autoplay: {
